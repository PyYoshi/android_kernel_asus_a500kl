#ifndef __a500kl_mp_GPIO_PINMUX_H
#define __a500kl_mp_GPIO_PINMUX_H

#include "asus_gpio_pinmux_setting.h"

static struct msm_gpiomux_config a500kl_mp_msm8926_gpio_configs[] __initdata= {
	{
		.gpio      = 0,		/* MAIN_CAM_ID1 */
		.settings = {
...
#endif  /* __a500kl_mp_GPIO_PINMUX_H  */
